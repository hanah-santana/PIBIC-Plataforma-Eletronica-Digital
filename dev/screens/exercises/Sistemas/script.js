...
const questions = [
  {
    title: '(TBG-2006) O equivalente na base 10 do número binário 00100111 é:',
    type: 'default',
    items: ['38', '39', '36', '34', '37'],
    resp: 'b',
  },
  {
    title: '(TBG-2006) O equivalente binário do número 47 na base 10 é:',
    type: 'subj',
    resp: '101111',
  },
  {
    title: 'Transforme para decimal os seguintes números binários:',
    type: 'itemsSubj',
    items: ['100110', '011110', '111011', '1010000'],
    resp: ['38', '30', '59', '80'],
  },
  {
    title: 'Transforme para binário os seguintes números decimais:',
    type: 'itemsSubj',
    items: ['10', '102', '215', '404'],
    resp: ['1010', '1100110', '11010111', '110010100'],
  },
  {
    title: 'Transforme para decimal os seguintes números octais:',
    type: 'itemsSubj',
    items: ['10', '100', '452', '777'],
    resp: ['8', '64', '298', '511'],
  },
  {
    title: '(SEPLAG/FUNED-2012) Ao convertermos o número hexadecimal C13 para binário teremos:',
    type: 'default',
    items: ['1101 0001 0011', '1100 0010 0011', '1100 0001 0100', '1100 0001 0011'],
    resp: 'd',
  },
  {
    title: '(ABIN-2004) julgue o item a seguir,'
  ...
  {
    title: '(CASAN-2015) Em informática, é importante'
  ...
  {
    title: 'As seguintes operações estão em BINÁRIO. Responda-as em DECIMAL:',
    type: 'itemsSubj',
